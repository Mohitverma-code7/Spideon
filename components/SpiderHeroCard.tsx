      ...
      <View style={styles.imageWrap}>
        ...
        <View style={styles.headlineBlock}>
          ...
          <Text style={styles.cardSubtitle}>
            {hero.fullName || "Identity classified in the multiverse"}
          </Text>
        </View>
      </View>
      ...
      <View style={styles.cardBody}>
        <View style={styles.kickerRow}>
          ...
          <Text style={styles.kickerText}>
            {hero.voiceActor || "Multiverse File"}
          </Text>
        </View>
...
const createStyles = (theme: ReturnType<typeof useAppTheme>["theme"]) =>
  StyleSheet.create({
    ...
    badge: {
      ...
      backgroundColor:
        theme.mode === "dark" ? "rgba(214,40,40,0.92)" : theme.colors.primary,
      borderRadius: 999,
    ...
    openBadge: {
      backgroundColor:
        theme.mode === "dark" ? "rgba(255,255,255,0.08)" : "#F3F7FF",
      borderRadius: 999,
      paddingHorizontal: 12,
      paddingVertical: 8,
      borderWidth: 1,
