  ...
  return (
    <Tab.Navigator
      screenOptions={({ route }) => ({
        ...
        tabBarIcon: ({ focused }) => (
          <View
            style={[styles.iconWrap, focused ? styles.iconWrapActive : null]}
          >
            <MaterialCommunityIcons
              name={tabIcons[route.name] || "circle"}
              size={20}
              color={
                focused ? theme.colors.tabIconActive : theme.colors.tabIcon
              }
            />
          </View>
        ),
...
const createStyles = (theme: any) =>
  StyleSheet.create({
    tabBar: {
      ...
      bottom: 16,
      backgroundColor:
        theme.mode === "dark" ? "rgba(8,16,31,0.98)" : "rgba(255,255,255,0.98)",
      borderTopWidth: 0,
      height: 78,
      paddingTop: 14,
      paddingBottom: 8,
      ...
      borderWidth: 1,
      borderColor:
        theme.mode === "dark" ? "rgba(43,127,255,0.18)" : "rgba(225,29,46,0.1)",
    ...
    iconWrap: {
      ...
      borderWidth: 1,
      borderColor:
        theme.mode === "dark" ? "rgba(255,255,255,0.05)" : "rgba(9,17,31,0.05)",
    },
    iconWrapActive: {
